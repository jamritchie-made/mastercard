...
// node_modules/@mc-made/web-components/dist/styles/component.styles.js
...
// node_modules/@mc-made/web-components/dist/utilities/localize.js
var translationRegistry = /* @__PURE__ */ new Map();
...
var LocalizeController = class {
  ...
  dir() {
    var _a3;
    const locale = this.resolveLocale();
    return ((_a3 = resolveTranslation(locale)) == null ? void 0 : _a3.$dir) ?? "ltr";
  }
};

// node_modules/@mc-made/web-components/dist/internal/made-element.js
...
var MadeElement = class extends LitElement {
  /**
   ...
   */
  static define(tag2, customElement = this) {
    const currentlyRegisteredElement = customElements.get(tag2);
    if (!currentlyRegisteredElement) {
      customElements.define(tag2, customElement);
    }
  }
  /**
  ...
  constructor() {
    ...
    Object.entries(this.constructor.dependencies).forEach(([tag2, component]) => {
      this.constructor.define(tag2, component);
    });
  }
};
MadeElement.dependencies = {};
var made_element_default = MadeElement;
__decorate([
  property()
...
@lit/reactive-element/development/decorators/query-assigned-nodes.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-IRZXDHPY.js.map
